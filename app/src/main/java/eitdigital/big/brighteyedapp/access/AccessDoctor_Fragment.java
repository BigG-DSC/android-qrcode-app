...
import eitdigital.big.brighteyedapp.doctors.DashboardDoctors_Activity;


public class AccessDoctor_Fragment extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.loginBtn:
			Intent intent = new Intent(getActivity(), DashboardDoctors_Activity.class);
			startActivity(intent);
			break;
